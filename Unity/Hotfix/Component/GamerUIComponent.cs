...
namespace Hotfix
{
    ...
    public class GamerUIComponent : Component
    {
        ...
        {
            GetUserInfo_RE getUserInfoRE = await SessionComponent.Instance.Session.Call<GetUserInfo_RE>(new GetUserInfo_RT() { UserID = this.GetEntity<Gamer>().UserID });
        ...
        public override void Dispose()
        {
            ...
            //回收玩家UI
            InitPanel();
            UI room = Hotfix.Scene.GetComponent<UIComponent>()?.Get(UIType.Room);
