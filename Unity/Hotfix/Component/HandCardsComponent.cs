...
{
    [ObjectEvent]
    public class HandCardsComponentEvent : ObjectEvent<HandCardsComponent>, IAwake<GameObject>
    {
    ...
    public class HandCardsComponent : Component
    {
        ...
        public void Reset()
        {
            //this.Panel.Get<GameObject>("HandCards")?.SetActive(false);
            //this.Panel.Get<GameObject>("Poker")?.SetActive(false);
            ClearHandCards();
            ClearPlayCards();
        }
        ...
        {
            GameObject handCardSprite = CreateCardSprite("HandCard", card.GetName(), this.Panel.Get<GameObject>("HandCards").transform);
        ...
        private void PopCard(Card card)
        {
            ...
            GameObject playCardSprite = CreateCardSprite("PlayCard", card.GetName(), this.Panel.Get<GameObject>("PlayCards").transform);
        ...
        {
            GameObject cardSpritePrefab = Resources.Load<GameObject>("UI").Get<GameObject>(prefabName);
            ...
            Sprite sprite = Resources.Load<GameObject>("UI").Get<GameObject>("Atlas").Get<Sprite>(cardName);
